...
export function Footer() {
  ...
  return (
    <footer className="bg-[rgba(5,5,10,0.4)] relative h-fit rounded-[32px] overflow-hidden m-6 border border-[var(--card-border)]">
      ...
      {/* Text hover effect */}
      <div className="flex h-[12rem] md:h-[16rem] lg:h-[22rem] -mt-12 md:-mt-24 lg:-mt-36 -mb-8 md:-mb-16 lg:-mb-24 opacity-30 md:opacity-50 lg:opacity-80 pointer-events-none w-full">

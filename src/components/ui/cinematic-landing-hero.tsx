...
const INJECTED_STYLES = `
  ...
  @keyframes btn-outer-glow {
    ...
    50% { box-shadow: 0 0 35px rgba(255,255,255,0.6), 0 0 70px rgba(255,255,255,0.3); }
  }
  @keyframes slow-pan {
  ...
  .glow-node-1 {
      position: absolute; top: 15%; left: 10%; width: 50vw; height: 50vw; max-width: 600px; max-height: 600px;
      background: radial-gradient(circle, rgba(59,130,246,0.15) 0%, transparent 60%);
      border-radius: 50%;
      animation: pulse-glow 8s infinite alternate ease-in-out;
  }
  .glow-node-2 {
      position: absolute; top: 40%; right: 5%; width: 60vw; height: 60vw; max-width: 700px; max-height: 700px;
      background: radial-gradient(circle, rgba(16,185,129,0.1) 0%, transparent 60%);
      border-radius: 50%;
      animation: pulse-glow 10s infinite alternate ease-in-out 2s;
  }
  .glow-node-3 {
      position: absolute; bottom: -10%; left: 30%; width: 55vw; height: 55vw; max-width: 650px; max-height: 650px;
      background: radial-gradient(circle, rgba(59,130,246,0.12) 0%, transparent 60%);
      border-radius: 50%;
      animation: pulse-glow 12s infinite alternate ease-in-out 1s;
  }
...
export function CinematicHero({ 
  ...
  return (
    ...
    >
      ...
      <div className="glowing-network" aria-hidden="true">
        <div className="glow-node-1" />
        <div className="glow-node-2" />
        <div className="glow-node-3" />
      </div>
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <a href="https://cal.com/ayush-yadav/15min?overlayCalendar=true" target="_blank" rel="noopener noreferrer" className="relative flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-white text-black font-semibold tracking-tight hover:scale-105 transition-all duration-300 shadow-[0_0_40px_rgba(255,255,255,0.15)] hover:shadow-[0_0_60px_rgba(255,255,255,0.25)] animate-[btn-outer-glow_3s_ease-in-out_infinite]">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
              <div className="text-lg font-bold leading-none">Book a Call</div>
            </a>
            <a href="https://wa.me/9779813761673?text=Hi%20Ayush%2C%20I%20want%20to%20know%20more%20about%20Flowstra%27s%20automation%20services." target="_blank" rel="noopener noreferrer" className="relative flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-transparent border border-white/20 text-white font-semibold tracking-tight hover:border-green-500/50 hover:shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-all duration-300">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <div className="text-lg font-bold leading-none">WhatsApp</div>
            </a>
          </div>
          <p className="text-[12px] text-white/40 mt-4 tracking-wide text-center">★ 5-star rated automation partner. No pitch, just a 15-min workflow audit.</p>
        </div>
      </div>
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none" style={{ perspective: "1500px" }}>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 pt-28 pb-6 lg:pt-32 lg:pb-12">
            
            {/* 1. TOP (Mobile) / RIGHT (Desktop): BRAND NAME */}
            <div className="card-right-text gsap-reveal order-1 lg:order-3 flex justify-center lg:justify-end z-0 w-full">
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-30" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                {/* Minimalist Dashboard/Abstract UI replacing the phone */}
                <div
                  ref={mockupRef}
                  className="relative w-[340px] h-[480px] rounded-[2rem] border border-white/10 bg-black/40 backdrop-blur-2xl shadow-[0_40px_80px_-15px_rgba(0,0,0,0.9)] flex flex-col will-change-transform transform-style-3d overflow-hidden"
                >
                  ...
                  <div className="px-6 py-5 border-b border-white/5 flex items-center justify-between">
                    ...
                    <div className="text-xs font-semibold text-white/40 tracking-wider">FLOWSTRA AI</div>
                  </div>

                  {/* Dashboard Content */}
                  <div className="p-6 flex-1 flex flex-col gap-6">
                    <div className="phone-widget rounded-2xl p-4 border border-white/5 bg-white/[0.02] shadow-inner flex flex-col items-center justify-center gap-2 drop-shadow-[0_15px_25px_rgba(0,0,0,0.5)]">
                      <span className="counter-val text-5xl font-extrabold tracking-tighter text-white">0</span>
                      <span className="text-[10px] text-blue-200/50 uppercase tracking-[0.15em] font-bold">{metricLabel}</span>
                    </div>

                    <div className="space-y-3 mt-auto">
                      <div className="phone-widget h-14 rounded-xl relative overflow-hidden flex items-center px-4 border border-blue-500/20 bg-blue-500/5">
                        <div className="absolute left-0 top-0 bottom-0 w-1 bg-blue-500 shadow-[0_0_10px_rgba(59,130,246,1)]" />
                        <svg className="w-5 h-5 text-blue-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                        </svg>
                        <div className="h-2 w-24 bg-blue-100/20 rounded-full" />
                      </div>
                      <div className="phone-widget h-14 rounded-xl relative overflow-hidden flex items-center px-4 border border-white/5 bg-white/[0.02]">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">System Active</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Optimal performance</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Lead Sync</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">+24% conversion</p>
                  </div>
                </div>
            ...
            <div className="card-left-text gsap-reveal order-3 lg:order-1 flex flex-col justify-center text-center lg:text-left z-30 w-full lg:max-w-none px-4 lg:px-0">
